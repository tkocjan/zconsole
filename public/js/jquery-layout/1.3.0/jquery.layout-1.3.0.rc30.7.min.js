...
a.trim((m||"")+" "+f)),!1)}!l&&!1!==h&&(b?(l=u[m],z=r[m],g=n[m],l.triggerHandler("layoutpane"+f,[m,l,g,z,t]),c&&l.triggerHandler("layoutpane"+c,[m,l,g,z,t])):(p.triggerHandler("layout"+f,[x,g,z,t]),c&&p.triggerHandler("layout"+c,[x,g,z,t])));(b&&"onresize_end"===d||"onsizecontent_end"===d)&&Za(m+"",!0);return h},$a=function(d){if(!M.mozilla){var a=u[d];"IFRAME"===n[d].tagName?a.css(j.hidden).css(j.visible):a.find("IFRAME").css(j.hidden).css(j.visible)}},va=function(d){var a=u[d],d=j[d].dir,a={minWidth:1001-
...
(z+c+"-hover ")+(z+g+c+"-hover ");m&&(c+=z+f+"-hover "+(z+g+f+"-hover "));"resizer"==b&&l.hasClass(z+"-sliding")&&(c+=z+"-sliding-hover "+(z+g+"-sliding-hover "));return a.trim(c)},Ja=function(d,m){var l=a(m||this);d&&"toggler"===l.data("layoutRole")&&d.stopPropagation();l.addClass(Ia(l))},Z=function(d,m){var l=a(m||this);l.removeClass(Ia(l,!0))},ab=function(){var d=a(this).data("layoutEdge"),m=n[d];!m.isClosed&&(!m.isResizing&&!n.paneResizing)&&(a.fn.disableSelection&&a("body").disableSelection(),
r.maskPanesEarly&&sa(d))},bb=function(d,m){var l=m||this,b=a(l).data("layoutEdge"),g=b+"ResizerLeave";L.clear(b+"_openSlider");L.clear(g);m?n.paneResizing||(a.fn.enableSelection&&a("body").enableSelection(),r.maskPanesEarly&&wa()):L.set(g,function(){bb(d,l)},200)},H=function(){return n.initialized||n.creatingLayout?!0:xa()},xa=function(d){var m=r;if(!p.is(":visible"))return!d&&(M.webkit&&"BODY"===p[0].tagName)&&setTimeout(function(){xa(!0)},50),!1;if(!cb("center").length)return aa(m.errors.centerPaneMissing);
n.creatingLayout=!0;a.extend(s,C(p,m.inset));y(void 0);a.each(j.allPanes,function(d,a){db(a,!0)});Ka();a.each(j.borderPanes,function(d,a){u[a]&&n[a].isVisible&&(V(a),da(a))});ea("center");a.each(j.allPanes,function(d,a){eb(a)});m.scrollToBookmarkOnLoad&&(d=self.location,d.hash&&d.replace(d.hash));x.hasParentLayout?m.resizeWithWindow=!1:m.resizeWithWindow&&a(window).bind("resize."+J,vb);delete n.creatingLayout;n.initialized=!0;h(x,a.layout.onReady);E("onload_end");return!0},La=function(d,m){var l=
y.call(this,d),b=u[l];if(b){var g=R[l],z=n[l],c=r[l],f=r.stateManagement||{},c=m?c.children=m:c.children;if(a.isPlainObject(c))c=[c];else if(!c||!a.isArray(c))return;a.each(c,function(d,m){a.isPlainObject(m)&&(m.containerSelector?b.find(m.containerSelector):g||b).each(function(){var d=a(this),g=d.data("layout");if(!g){fb({container:d,options:m},z);if(f.includeChildren&&n.stateData[l]){var g=(n.stateData[l].children||{})[m.instanceKey],b=m.stateManagement||(m.stateManagement={autoLoad:!0});!0===b.autoLoad&&
g&&(b.autoSave=!1,b.includeChildren=!0,b.autoLoad=a.extend(!0,{},g))}(g=d.layout(m))&&ya(l,g)}})})}},fb=function(d,a){var l=d.container,b=d.options,g=b.stateManagement,c=b.instanceKey||l.data("layoutInstanceKey");c||(c=(g&&g.cookie?g.cookie.name:"")||b.name);c=c?c.replace(/[^\w-]/gi,"_").replace(/_{2,}/g,"_"):"layout"+ ++a.childIdx;b.instanceKey=c;l.data("layoutInstanceKey",c);return c},ya=function(d,m){var l=u[d],b=Y[d],g=n[d];a.isPlainObject(b)&&(a.each(b,function(d,a){a.destroyed&&delete b[d]}),
a.isEmptyObject(b)&&(b=Y[d]=null));!m&&!b&&(m=l.data("layout"));m&&(m.hasParentLayout=!0,l=m.options,fb(m,g),b||(b=Y[d]={}),b[l.instanceKey]=m.container.data("layout"));x[d].children=Y[d];m||La(d)},vb=function(){var d=r,a=Number(d.resizeWithWindowDelay);10>a&&(a=100);L.clear("winResize");L.set("winResize",function(){L.clear("winResize");L.clear("winResizeRepeater");var a=C(p,d.inset);(a.innerWidth!==s.innerWidth||a.innerHeight!==s.innerHeight)&&la()},a);L.data.winResizeRepeater||gb()},gb=function(){var d=
Number(r.resizeWithWindowMaxDelay);0<d&&L.set("winResizeRepeater",function(){gb();la()},d)},hb=function(){E("onunload_start");h(x,a.layout.onUnload);E("onunload_end")},ib=function(d){d=d?d.split(","):j.borderPanes;a.each(d,function(d,b){var c=r[b];if(c.enableCursorHotkey||c.customHotkey)return a(document).bind("keydown."+J,v),!1})},cb=function(d){d=r[d].paneSelector;if("#"===d.substr(0,1))return p.find(d).eq(0);var a=p.children(d).eq(0);return a.length?a:p.children("form:first").children(d).eq(0)},
db=function(d,a){if(a||H()){var l=r[d],c=n[d],g=j[d],z=g.dir,t="center"===d,e={},k=u[d],q,h;k?Ma(d,!1,!0,!1):R[d]=!1;k=u[d]=cb(d);if(k.length){k.data("layoutCSS")||k.data("layoutCSS",D(k,"position,top,left,bottom,right,width,height,overflow,zIndex,display,backgroundColor,padding,margin,border"));x[d]={name:d,pane:u[d],content:R[d],options:r[d],state:n[d],children:Y[d]};k.data({parentLayout:x,layoutPane:x[d],layoutEdge:d,layoutRole:"pane"}).css(g.cssReq).css("zIndex",r.zIndexes.pane_normal).css(l.applyDemoStyles?
...
l.closable&&!l.initHidden?fa(d,!0,!0):l.initHidden||l.initClosed?Oa(d):c.noRoom||k.css("display","block");k.css("visibility","visible");l.showOverflowOnHover&&k.hover(O,I);n.initialized&&eb(d)}else u[d]=!1}},eb=function(d){var a=u[d],b=n[d],c=r[d];a&&(a.data("layout")&&ya(d,a.data("layout")),b.isVisible&&(n.initialized?la():ma(d),c.triggerEventsOnLoad?E("onresize_end",d):Za(d,!0)),c.initChildren&&c.children&&La(d))},jb=function(d){d=d?d.split(","):j.borderPanes;a.each(d,function(d,a){var b=u[a],g=
G[a],c=n[a],f=j[a].side,e={};if(b){switch(a){case "north":e.top=s.inset.top;e.left=s.inset.left;e.right=s.inset.right;break;case "south":e.bottom=s.inset.bottom;e.left=s.inset.left;e.right=s.inset.right;break;case "west":e.left=s.inset.left;break;case "east":e.right=s.inset.right}b.css(e);g&&c.isClosed?g.css(f,s.inset[f]):g&&!c.isHidden&&g.css(f,s.inset[f]+ca(a))}})},Ka=function(d){d=d?d.split(","):j.borderPanes;a.each(d,function(d,b){var c=u[b];G[b]=!1;P[b]=!1;if(c){var g=r[b],c=n[b],f="#"===g.paneSelector.substr(0,
1)?g.paneSelector.substr(1):"",e=g.resizerClass,h=g.togglerClass,k="-"+b,q=x[b],i=q.resizer=G[b]=a("<div></div>"),q=q.toggler=g.closable?P[b]=a("<div></div>"):!1;!c.isVisible&&g.slidable&&i.attr("title",g.tips.Slide).css("cursor",g.sliderCursor);i.attr("id",f?f+"-resizer":"").data({parentLayout:x,layoutPane:x[b],layoutEdge:b,layoutRole:"resizer"}).css(j.resizers.cssReq).css("zIndex",r.zIndexes.resizer_normal).css(g.applyDemoStyles?j.resizers.cssDemo:{}).addClass(e+" "+e+k).hover(Ja,Z).hover(ab,bb).appendTo(p);
g.resizerDblClickToggle&&i.bind("dblclick."+J,ka);q&&(q.attr("id",f?f+"-toggler":"").data({parentLayout:x,layoutPane:x[b],layoutEdge:b,layoutRole:"toggler"}).css(j.togglers.cssReq).css(g.applyDemoStyles?j.togglers.cssDemo:{}).addClass(h+" "+h+k).hover(Ja,Z).bind("mouseenter",ab).appendTo(i),g.togglerContent_open&&a("<span>"+g.togglerContent_open+"</span>").data({layoutEdge:b,layoutRole:"togglerContent"}).data("layoutRole","togglerContent").data("layoutEdge",b).addClass("content content-open").css("display",
"none").appendTo(q),g.togglerContent_closed&&a("<span>"+g.togglerContent_closed+"</span>").data({layoutEdge:b,layoutRole:"togglerContent"}).addClass("content content-closed").css("display","none").appendTo(q),kb(b));var g=b,A=a.layout.plugins.draggable,g=g?g.split(","):j.borderPanes;a.each(g,function(d,b){var g=r[b];if(!A||!u[b]||!g.resizable)return g.resizable=!1,!0;var m=n[b],l=r.zIndexes,c=j[b],f="horz"==c.dir?"top":"left",z=G[b],e=g.resizerClass,t=0,q,k,F=e+"-drag",h=e+"-"+b+"-drag",i=e+"-dragging",
...
b,w=j.style,w.display="block",w.position="absolute",w.background="#FFF",i&&(j.frameborder=0,j.src="about:blank",w.opacity=0,w.filter="Alpha(Opacity='0')",w.border=0),"IFRAME"==c.tagName?(w.zIndex=f.pane_normal+1,p.append(j)):(s.addClass("ui-layout-mask-inside-pane"),w.zIndex=l.maskZindex||f.content_mask,w.top=0,w.left=0,w.width="100%",w.height="100%",m.append(j)),F=F.add(j),$=$.add(j);m=F}m.each(function(){mb.call(this);this.style.zIndex=h.isSliding?g.pane_sliding+1:g.pane_normal+1;this.style.display=
...
"none"!=i.fxName_open;k.isMoving=!0;k.isVisible=!0;k.isClosed=!1;s&&(k.isHidden=!1);q?(Ca(e,!0),h.show(i.fxName_open,i.fxSettings_open,i.fxSpeed_open,function(){Ca(e,!1);k.isVisible&&g();a()})):(nb(e),g(),a())}})}},Pa=function(d,b){var c=u[d],f=G[d],g=P[d],e=r[d],h=n[d],i=j[d].side,k=e.resizerClass,q=e.togglerClass,p="-"+d;f.css(i,s.inset[i]+ca(d)).removeClass(k+"-closed "+k+p+"-closed").addClass(k+"-open "+k+p+"-open");h.isSliding?f.addClass(k+"-sliding "+k+p+"-sliding"):f.removeClass(k+"-sliding "+
...
d),h.isShowing&&E("onshow_end",d),n.initialized&&E("onresize_end",d)},ob=function(a){function b(){g.isClosed?g.isMoving||oa(f,!0):ta(f,!0)}if(H()){var c=U(a),f=y.call(this,a),g=n[f],a=r[f].slideDelay_open;c&&c.stopImmediatePropagation();g.isClosed&&c&&"mouseenter"===c.type&&0<a?L.set(f+"_openSlider",b,a):b()}},Sa=function(b){function c(){g.isClosed?ta(h,!1):g.isMoving||fa(h)}if(H()){var e=U(b),h=y.call(this,b),b=r[h],g=n[h],i=g.isMoving?1E3:300;!g.isClosed&&!g.isResizing&&("click"===b.slideTrigger_close?
...
w:B)(u[t],d.attempt);q.css(Q,d.cssSize);d.actual="width"==Q?q.outerWidth():q.outerHeight();d.correct=e===d.actual;1===b.length&&(aa(h,!1,!0),aa(c,!1,!0));aa(d,!1,!0);if(3<b.length)break;b.push(d);c=b[b.length-1]}k.size=e;a.extend(k,C(q));k.isVisible&&q.is(":visible")&&(ra&&ra.css(A,e+s.inset[A]),ma(t));!l&&(!lb&&n.initialized&&k.isVisible)&&E("onresize_end",t);l||(k.isSliding||ea("horz"==j[t].dir?"":"center",lb,g),na());c=j.oppositeEdge[t];e<v&&n[c].noRoom&&(V(c),da(c,!1,l));1<b.length&&aa(h+"\nSee the Error Console for details.",
!0,!0)}if(H()){var t=y.call(this,c),ia=r[t],k=n[t],q=u[t],ra=G[t],A=j[t].side,Q=j[t].sizeType.toLowerCase(),lb=k.isResizing&&!ia.triggerEventsDuringLiveResize,x=!0!==h&&ia.animatePaneSizing,v,D;p.queue(function(c){V(t);v=k.size;e=ba(t,e);e=f(e,ba(t,ia.minSize));e=b(e,k.maxSize);if(e<k.minSize)c(),da(t,!1,l);else{if(!g&&e===v)return c();!l&&(n.initialized&&k.isVisible)&&E("onresize_start",t);D=("horz"==j[t].dir?w:B)(u[t],e);if(x&&q.is(":visible")){var d=a.layout.effects.size[t]||a.layout.effects.size.all,
...
!c&&n.initialized&&E("onresize_end",d)}})},la=function(b){y(b);if(p.is(":visible"))if(n.initialized){if(a.extend(s,C(p,r.inset)),s.outerHeight){!0===b&&jb();if(!1===E("onresizeall_start"))return!1;var c,e,f;a.each(["south","north","east","west"],function(a,b){u[b]&&(e=r[b],f=n[b],f.autoResize&&f.size!=e.size?ga(b,e.size,!0,!0,!0):(V(b),da(b,!1,!0,!0)))});ea("",!0,!0);na();a.each(j.allPanes,function(a,b){(c=u[b])&&n[b].isVisible&&E("onresize_end",b)});E("onresizeall_end")}}else xa()},Za=function(b,
...
a(this);k.css("marginTop",c((D-k.outerHeight())/2))})}Z(0,p)}if(!n.initialized&&(f.initHidden||g.noRoom))i.hide(),p&&p.hide()}}})},kb=function(a){if(H()){var b=y.call(this,a),a=P[b],c=r[b];a&&(c.closable=!0,a.bind("click."+J,function(a){a.stopPropagation();ka(b)}).css("visibility","visible").css("cursor","pointer").attr("title",n[b].isClosed?c.tips.Open:c.tips.Close).show())}},Ra=function(b,c){a.layout.plugins.buttons&&a.each(n[b].pins,function(e,f){a.layout.buttons.setPinState(x,a(f),b,c)})},p=a(this).eq(0);
if(!p.length)return aa(r.errors.containerMissing);if(p.data("layoutContainer")&&p.data("layout"))return p.data("layout");var u={},R={},G={},P={},$=a([]),s=n.container,J=n.id,x={options:r,state:n,container:p,panes:u,contents:R,resizers:G,togglers:P,hide:Oa,show:Ba,toggle:ka,open:oa,close:fa,slideOpen:ob,slideClose:Sa,slideToggle:function(a){a=y.call(this,a);ka(a,!0)},setSizeLimits:V,_sizePane:ga,sizePane:za,sizeContent:ma,swapPanes:function(b,c){function e(b){var c=u[b],d=R[b];return!c?!1:{pane:b,
...
G[g]&&G[g].remove();G[c]&&G[c].remove();G[g]=G[c]=P[g]=P[c]=!1;h(i,c);h(p,g);i=p=v=null;u[g]&&u[g].css(j.visible);u[c]&&u[c].css(j.visible);la();E("onswap_end",g);E("onswap_end",c)}}},showMasks:sa,hideMasks:wa,initContent:Na,addPane:db,removePane:Ma,createChildren:La,refreshChildren:ya,enableClosable:kb,disableClosable:function(a,b){if(H()){var c=y.call(this,a),e=P[c];e&&(r[c].closable=!1,n[c].isClosed&&oa(c,!1,!0),e.unbind("."+J).css("visibility",b?"hidden":"visible").css("cursor","default").attr("title",
...
c)});p.data("layoutCSS")&&!p.data("layoutRole")&&p.css(p.data("layoutCSS")).removeData("layoutCSS");"BODY"===s.tagName&&(p=a("html")).data("layoutCSS")&&p.css(p.data("layoutCSS")).removeData("layoutCSS");h(x,a.layout.onDestroy);hb();for(var e in x)e.match(/^(container|options)$/)||delete x[e];x.destroyed=!0;return x},initPanes:H,resizeAll:la,runCallbacks:E,hasParentLayout:!1,children:Y,north:!1,south:!1,west:!1,east:!1,center:!1},Ta;var S,Ua,N,Da,ha,pa,T,i=a.layout.transformData(i,!0),i=a.layout.backwardCompatibility.renameAllOptions(i);
if(!a.isEmptyObject(i.panes)){S=a.layout.optionsMap.noDefault;ha=0;for(pa=S.length;ha<pa;ha++)N=S[ha],delete i.panes[N];S=a.layout.optionsMap.layout;ha=0;for(pa=S.length;ha<pa;ha++)N=S[ha],delete i.panes[N]}S=a.layout.optionsMap.layout;var wb=a.layout.config.optionRootKeys;for(N in i)Da=i[N],0>a.inArray(N,wb)&&0>a.inArray(N,S)&&(i.panes[N]||(i.panes[N]=a.isPlainObject(Da)?a.extend(!0,{},Da):Da),delete i[N]);a.extend(!0,r,i);a.each(j.allPanes,function(b,c){j[c]=a.extend(!0,{},j.panes,j[c]);Ua=r.panes;
...
{};h=j.all||null;j=j[c]||null;e[i]=e[i]||f[i]||e.fxSpeed||f.fxSpeed||null;e[k]=a.extend(!0,{},h,j,f.fxSettings,e.fxSettings,f[k],e[k])});delete e.fxName;delete e.fxSpeed;delete e.fxSettings;T.resizerClass||(T.resizerClass="ui-layout-resizer");T.togglerClass||(T.togglerClass="ui-layout-toggler")}T.paneClass||(T.paneClass="ui-layout-pane")});var Ea=i.zIndex,ua=r.zIndexes;0<Ea&&(ua.pane_normal=Ea,ua.content_mask=f(Ea+1,ua.content_mask),ua.resizer_normal=f(Ea+2,ua.resizer_normal));delete r.panes;var xb=
r,pb=n;pb.creatingLayout=!0;h(x,a.layout.onCreate);if(!1===E("onload_start"))Ta="cancel";else{var Va=p[0],W=a("html"),qb=s.tagName=Va.tagName,rb=s.id=Va.id,sb=s.className=Va.className,K=r,Fa=K.name,Wa={},Ga=p.data("parentLayout"),Ha=p.data("layoutEdge"),Xa=Ga&&Ha,qa=a.layout.cssNum,Ya,X;s.selector=p.selector.split(".slice")[0];s.ref=(K.name?K.name+" layout / ":"")+qb+(rb?"#"+rb:sb?".["+sb+"]":"");s.isBody="BODY"===qb;!Xa&&!s.isBody&&(Ya=p.closest("."+a.layout.defaults.panes.paneClass),Ga=Ya.data("parentLayout"),
Ha=Ya.data("layoutEdge"),Xa=Ga&&Ha);p.data({layout:x,layoutContainer:J}).addClass(K.containerClass);var tb={destroy:"",initPanes:"",resizeAll:"resizeAll",resize:"resizeAll"};for(Fa in tb)p.bind("layout"+Fa.toLowerCase()+"."+J,x[tb[Fa]||Fa]);Xa&&(x.hasParentLayout=!0,Ga.refreshChildren(Ha,x));p.data("layoutCSS")||(s.isBody?(p.data("layoutCSS",a.extend(D(p,"position,margin,padding,border"),{height:p.css("height"),overflow:p.css("overflow"),overflowX:p.css("overflowX"),overflowY:p.css("overflowY")})),
...
10)||0,K.outset={top:X,bottom:X,left:X,right:X}):K.outset={top:qa(W,"paddingTop"),bottom:qa(W,"paddingBottom"),left:qa(W,"paddingLeft"),right:qa(W,"paddingRight")},W.css(Wa).css({height:"100%",border:"none",padding:0,margin:0}),M.isIE6?(p.css({width:"100%",height:"100%",border:"none",padding:0,margin:0,position:"relative"}),K.inset||(K.inset=C(p).inset)):(p.css({width:"auto",height:"auto",margin:0,position:"absolute"}),p.css(K.outset)),a.extend(s,C(p,K.inset));else{var ub=p.css("position");(!ub||
!ub.match(/(fixed|absolute|relative)/))&&p.css("position","relative");p.is(":visible")&&(a.extend(s,C(p,K.inset)),1>s.innerHeight&&aa(K.errors.noContainerHeight.replace(/CONTAINER/,s.ref)))}qa(p,"minWidth")&&p.parent().css("overflowX","auto");qa(p,"minHeight")&&p.parent().css("overflowY","auto")}catch(yb){}ib();a(window).bind("unload."+J,hb);h(x,a.layout.onLoad);xb.initPanes&&xa();delete pb.creatingLayout;Ta=n.initialized}return"cancel"===Ta?null:x};a(function(){var b=a.layout.browser;b.msie&&(b.boxModel=
